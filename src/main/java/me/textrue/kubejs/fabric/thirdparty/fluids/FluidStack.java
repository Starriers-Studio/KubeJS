...
public final class FluidStack implements MutableDataComponentHolder {
	...
	public FluidType getFluidType() {
		return getFluid().kjs$getFluidType();
	}
	...
	public PatchedDataComponentMap getComponents() {
		return (PatchedDataComponentMap) (!this.isEmpty() ? this.variant.getComponentMap() : DataComponentMap.EMPTY);
	}
	...
	public <T> T set(DataComponentType<? super T> type, @Nullable T component) {
		return this.getComponents().set(type, component);
	}
	...
	public void applyComponents(DataComponentPatch patch) {
		this.variant.withComponentChanges(patch);
	}
	...
	public void applyComponents(DataComponentMap components) {
		this.variant.getComponentMap().keySet().addAll(components.keySet());
	}
