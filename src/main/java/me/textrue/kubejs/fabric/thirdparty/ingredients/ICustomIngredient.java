...
public interface ICustomIngredient extends CustomIngredient {
	 ...
	 * <li>At least one stack must be returned for the ingredient not to be considered {@linkplain Ingredient#kjs$hasNoItems() accidentally empty}.</li>
	 ...
	 *
	 * <p>The type must be registered to {@link ThirdPartyRegistries#INGREDIENT_TYPES}.
	 */
	...
	default Ingredient toVanilla() {
		return new Ingredient((Stream<? extends Ingredient.Value>) this);
	}
}
