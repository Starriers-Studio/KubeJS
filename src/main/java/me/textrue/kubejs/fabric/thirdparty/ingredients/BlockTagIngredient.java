...
public class BlockTagIngredient implements ICustomIngredient {
	...
	public static final CustomIngredientSerializer<BlockTagIngredient> SERIALIZER = (CustomIngredientSerializer<BlockTagIngredient>) CustomIngredientSerializer.get(ThirdPartyRegistry.id("block_tag"));
	...
	public IngredientType<?> getType() {
		return ThirdPartyRegistry.BLOCK_TAG_INGREDIENT;
	}
