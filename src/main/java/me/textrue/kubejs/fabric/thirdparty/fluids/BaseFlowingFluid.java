package me.textrue.kubejs.fabric.thirdparty.fluids;

import java.util.Optional;

import me.textrue.kubejs.fabric.thirdparty.fluids.extensions.ConvertToSourceFluid;
import me.textrue.kubejs.fabric.thirdparty.fluids.extensions.ClientFluidTypeExtensions;
import me.textrue.kubejs.fabric.thirdparty.fluids.extensions.FluidProvider;
...
public abstract class BaseFlowingFluid extends FlowingFluid implements ConvertToSourceFluid, FluidProvider {
	...
	public boolean canConvertToSource(FluidState state, Level level, BlockPos pos) {
		return this.kjs$getFluidType().canConvertToSource(state, level, pos);
	}
	...
	public Optional<SoundEvent> getPickupSound() {
		return Optional.ofNullable(kjs$getFluidType().getSound(SoundActions.BUCKET_FILL));
	}

	public static class Flowing extends BaseFlowingFluid {
		private ClientFluidTypeExtensions clientExtensions;
		...
		@Override
		public void setFluidTypeExtensions(ClientFluidTypeExtensions extensions) {
			this.clientExtensions = extensions;
		}

		@Override
		public ClientFluidTypeExtensions getFluidTypeExtensions() {
			return null;
		}
	}
