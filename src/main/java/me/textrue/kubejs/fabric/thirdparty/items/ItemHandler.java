...
public interface ItemHandler extends SlottedStorage<ItemVariant> {
	 ...
	 * Use {@link ItemHandlerModifiable#setStackInSlot(int, ItemStack)} for modification.
	 */
	 ...
	 */
	default long insertItem(int slot, ItemVariant resource, long maxAmount, TransactionContext transaction) {
