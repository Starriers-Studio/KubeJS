...
import me.textrue.kubejs.fabric.thirdparty.ingredients.IngredientCodecs;
import me.textrue.kubejs.fabric.thirdparty.fluids.FluidStack;
import me.textrue.kubejs.fabric.thirdparty.fluids.FluidStackLinkedSet;
...
public abstract class FluidIngredient implements Predicate<FluidStack> {
	 ...
	 *
	 * @see IngredientCodecs#MAP_CODEC_NONEMPTY
	 */
	...
	public static final StreamCodec<RegistryFriendlyByteBuf, FluidIngredient> STREAM_CODEC = new StreamCodec<>() {
		private static final StreamCodec<RegistryFriendlyByteBuf, FluidIngredient> DISPATCH_CODEC = ByteBufCodecs.registry(ThirdPartyRegistries.Keys.FLUID_INGREDIENT_TYPES)
	 ...
	 *         <p>
	 * @see me.textrue.kubejs.fabric.thirdparty.ingredients.ICustomIngredient#getItems()
	 */
	 ...
	 * @see me.textrue.kubejs.fabric.thirdparty.ingredients.ICustomIngredient#isSimple()
	 */
	 ...
	 *
	 * <p>The type <b>must</b> be registered to {@link ThirdPartyRegistries#FLUID_INGREDIENT_TYPES}.
	 */
	...
	private static MapCodec<FluidIngredient> singleOrTagCodec() {
		return ThirdPartyExtraCodecs.xor(
	...
	private static MapCodec<FluidIngredient> makeMapCodec() {
		return ThirdPartyExtraCodecs.<FluidIngredientType<?>, FluidIngredient, FluidIngredient>dispatchMapOrElse(
			ThirdPartyRegistries.FLUID_INGREDIENT_TYPES.byNameCodec(),
