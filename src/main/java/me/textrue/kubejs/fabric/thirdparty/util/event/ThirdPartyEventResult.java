 ...
 */
public final class ThirdPartyEventResult {
	private static final ThirdPartyEventResult TRUE = new ThirdPartyEventResult(true, true);
	private static final ThirdPartyEventResult STOP = new ThirdPartyEventResult(true, null);
	private static final ThirdPartyEventResult PASS = new ThirdPartyEventResult(false, null);
	private static final ThirdPartyEventResult FALSE = new ThirdPartyEventResult(true, false);
	 ...
	 */
	public static ThirdPartyEventResult pass() {
		return PASS;
	}
	 ...
	 */
	public static ThirdPartyEventResult interrupt(Boolean value) {
	 ...
	 * @return an event that interrupts the event
	 */
	public static ThirdPartyEventResult interruptTrue() {
		return TRUE;
	}
	 ...
	 * @return an event that interrupts the event
	 */
	public static ThirdPartyEventResult interruptDefault() {
		return STOP;
	}
	 ...
	 * @return an event that interrupts the event
	 */
	public static ThirdPartyEventResult interruptFalse() {
		return FALSE;
	}
	...
	ThirdPartyEventResult(boolean interruptsFurtherEvaluation, Boolean value) {
