...
public final class CompoundFluidIngredient extends FluidIngredient {
	public static final MapCodec<CompoundFluidIngredient> CODEC = ThirdPartyExtraCodecs.aliasedFieldOf(FluidIngredient.LIST_CODEC_NON_EMPTY, "children", "ingredients").xmap(CompoundFluidIngredient::new, CompoundFluidIngredient::children);
	...
	public FluidIngredientType<?> getType() {
		return ThirdPartyRegistry.COMPOUND_FLUID_INGREDIENT_TYPE;
	}
