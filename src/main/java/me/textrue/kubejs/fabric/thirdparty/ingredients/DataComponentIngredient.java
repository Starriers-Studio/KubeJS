...
public class DataComponentIngredient implements ICustomIngredient {
	...
	public static final CustomIngredientSerializer<DataComponentIngredient> SERIALIZER = (CustomIngredientSerializer<DataComponentIngredient>) CustomIngredientSerializer.get(ThirdPartyRegistry.id("components"));
	...
	public IngredientType<?> getType() {
		return ThirdPartyRegistry.DATA_COMPONENT_INGREDIENT_TYPE;
	}
